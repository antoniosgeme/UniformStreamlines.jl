...
makedocs(;
    modules = [UniformStreamlines],
    authors = "Antonios Gementzopoulos",
    repo = "https://github.com/antoniosgeme/UniformStreamlines.jl/blob/{commit}{path}#{line}",
    sitename = "UniformStreamlines.jl",
    format = Documenter.HTML(; canonical = "https://antoniosgeme.github.io/UniformStreamlines.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/antoniosgeme/UniformStreamlines.jl")
